#YOUR NAME
#SE126.02 #section number
#W1D2 Lab Demo: SE116 Review
#1-7-2025 [W1D2]

#PROGRAM PROMPT: This is a temperature conversion program, it allows a user to enter as many Fahrenheit temps as they'd like and then shows the Celsius conversoion for each. It also counts the number of temps and determines the average of all temps entered. #can copy program prompt
...
def again(): #<----- Function header
    '''this function asks if a user if theyd like to enter another temp, checks the response for validity, and returns a valid response back to the main program'''
...
def converter(f):
    '''this function is passed a tempF value ('f' parameter), coverts to celsius, and returns the tempC value'''
...
while answer == "y" or answer=="Y" and temp_total>=0:
    ...
    temp_count = temp_count + 1 # temp count += 1
    temp_total += tempF
    ...
    answer = again() 
    # return the value of this function will replace this call as final result for 'answer'
